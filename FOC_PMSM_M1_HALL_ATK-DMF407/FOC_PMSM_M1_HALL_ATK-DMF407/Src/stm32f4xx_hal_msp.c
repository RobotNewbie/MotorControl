...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = M1_TEMPERATURE_Pin|M1_CURR_AMPL_V_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, M1_TEMPERATURE_Pin|M1_CURR_AMPL_V_Pin);

    HAL_GPIO_DeInit(GPIOB, M1_CURR_AMPL_U_Pin|M1_BUS_VOLTAGE_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  if(htim_base->Instance==TIM5)
  {
    ...
    PH12     ------> TIM5_CH3
    */
    HAL_GPIO_DeInit(GPIOH, M1_HALL_H1_Pin|M1_HALL_H2_Pin|M1_HALL_H3_Pin);
