...
#define SW_DEADTIME_NS                      450 /*!< Dead-time to be inserted by FW, only if low side signals are enabled */
...
#define PID_TORQUE_KI_DEFAULT               3591
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2077
#define PID_FLUX_KI_DEFAULT                 3591
...
#define PID_SPEED_KP_DEFAULT                3201/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                1147/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            1080
...
#define PHASE5_FINAL_SPEED_UNIT             (1200*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A              4
